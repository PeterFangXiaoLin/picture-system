...
(
    ...
    inviteStatus tinyint    default 0                 not null comment '邀请确认状态：0-待确认，1-已接受，2-已拒绝',
    createUserId bigint                                not null comment '邀请人 id',
    createTime datetime     default CURRENT_TIMESTAMP not null comment '创建时间',
    updateTime datetime     default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP comment '更新时间',
    -- 索引设计
    ...
    INDEX idx_createUserId (createUserId)           -- 提升按邀请人查询的性能
