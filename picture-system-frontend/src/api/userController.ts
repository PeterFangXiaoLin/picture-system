...
/** 根据 id 获取用户（仅管理员） 根据 id 获取用户（仅管理员） GET /api/user/get */
...
/** 获取当前登录的用户信息 获取当前登录的用户信息 GET /api/user/get/login */
...
/** 根据 id 获取脱敏后的用户 根据 id 获取脱敏后的用户 GET /api/user/get/vo */
...
/** 分页获取用户列表（仅管理员） 分页获取用户列表（仅管理员） POST /api/user/list/page/vo */
...
/** 用户注销（退出登录） 用户注销（退出登录） POST /api/user/logout */
