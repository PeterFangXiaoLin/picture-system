...
/** 根据id获取空间（仅管理员可用） GET /api/space/get */
...
/** 获取空间级别 GET /api/space/list/level */
...
/** 分页获取空间列表（仅管理员） POST /api/space/list/page */
