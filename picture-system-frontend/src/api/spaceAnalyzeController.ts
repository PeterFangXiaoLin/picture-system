...
/** 获取空间分类情况 POST /api/space/analyze/category */
...
/** 获取空间使用TOP N POST /api/space/analyze/rank */
...
/** 获取空间图片大小统计 POST /api/space/analyze/size */
...
/** 获取空间标签情况 POST /api/space/analyze/tag */
...
/** 获取空间用户上传情况 POST /api/space/analyze/user */
